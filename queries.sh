...
echo "$($PSQL "SELECT DISTINCT(name) FROM teams FULL JOIN games ON teams.team_id = games.winner_id WHERE games.winner_goals > games.opponent_goals ORDER BY name")"
